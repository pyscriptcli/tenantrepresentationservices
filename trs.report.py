...
# --- GLOBAL STYLESHEET (MAX REAL ESTATE, ZERO PADDING, NO HORIZONTAL SCROLL) ---
st.markdown("""
<style>
    ...
    * { font-family: 'Google Sans', 'Roboto', 'Segoe UI', sans-serif !important; }
    ...
    /* Hide Streamlit header and decorations */
    ...
    /* Main container: full height, no padding at bottom */
    .appview-container, 
    .main, 
    ...
    /* Report iframe: full width, tall enough, no internal scrollbar */
    iframe[title="streamlit_components.components.html"] {
        ...
        margin: 0px !important;
        padding: 0px !important;
        overflow: hidden !important;  /* prevents iframe scrollbar */
    }
...
# --- COMPLETE HTML BLUEPRINT (NO FIXED COLUMN WIDTHS, AUTO LAYOUT, WRAPPING) ---
HTML_FRAMEWORK = """
<!DOCTYPE html>
<html>
<head>
    <style type="text/css">
        ...
        /* Table layout: auto, full width, no horizontal overflow */
        .ritz .waffle {
        ...
        /* Remove fixed column widths; use auto */
        .ritz .waffle col { width: auto !important; }
    ...
    if not site_data.empty:
        ...
        with tab_report:
            try:
                ...
                # Render with large height and no iframe scrollbar – page will scroll
