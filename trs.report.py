...
# https://drive.google.com/drive/folders/13sLmXzxQvV12_ypTBRG2QW1yVIHaanba
...
def get_image_from_drive(filename):
    ...
    try:
        # The folder is publicly shared, so we can use the direct download URL
        # We need to find the file ID first by searching the folder
        
        # Search for the file using Google Drive API (public search)
        # Since the folder is public, we can use a simple search
        search_url = f"https://www.googleapis.com/drive/v3/files?q=name='{filename}' and '{DRIVE_FOLDER_ID}' in parents&fields=files(id,name)&key=AIzaSyCPVoj1E5HhQ-4PxR2-syjf5lY8Oo8KZ38"
...
# --- COMPLETE HTML BLUEPRINT - Maximized for Information Tab ---
HTML_FRAMEWORK = """
<!DOCTYPE html>
<html>
<head>
    <style type="text/css">
        ...
        .ritz .waffle .s14, .s16, .s18, .s19, .s21 {
            background-color: #b7b7b7;
            text-align: left;
            color: #ff0000;
            font-size: 9pt !important;
        ...
        .ritz .waffle .s3, .s6, .s7, .s11, .s12, .s24, .s25 {
            background-color: #ffffff;
            padding: 4px 6px !important;
        }
        
        .freezebar-origin-ltr { background-color: #f8f9fa; }
        .column-headers-background { background-color: #f8f9fa; text-align: center; font-size: 8pt; color: #444746; }
        .row-headers-background { background-color: #f8f9fa; text-align: center; font-size: 8pt; color: #444746; }
    </style>
</head>
<body>
...
<table class="waffle" cellspacing="0" cellpadding="0">
    <colgroup>
        <col style="width:200px;"><col style="width:90px;"><col style="width:80px;"><col style="width:90px;"><col style="width:85px;"><col style="width:90px;"><col style="width:75px;"><col style="width:15px;"><col style="width:130px;"><col style="width:160px;"><col style="width:90px;"><col style="width:90px;"><col style="width:90px;"><col style="width:115px;"><col style="width:29px;">
    </colgroup>
    <tbody>
        ...
        <tr><td class="s5" colspan="2">No. of Storeys (If Bldg Lessee)</td><td class="s4" colspan="5"></td><td class="s3"></td><td class="s5" colspan="2">Tenant is the Owner</td><td class="s4" colspan="5"></td></tr>
        <tr><td class="s5" colspan="2">Type of Structure(if Bldg Lessee)</td><td class="s4" colspan="5"></td><td class="s3"></td><td class="s5" colspan="2">Lease Type</td><td class="s4" colspan="5">_LEASE_TYPE_</td></tr>
        <tr><td class="s2">Soil Profile</td><td class="s2"></td><td class="s4" colspan="5"></td><td class="s3"></td><td class="s5" colspan="2">Principal COL</td><td class="s4" colspan="5"></td></tr>
        <tr>
        ...
        <tr><td class="s2">Power</td><td class="s10"></td><td class="s2">Aircon</td><td class="s10"></td><td class="s5" colspan="2">LPG Fire Pro</td><td class="s10"></td><td class="s3"></td><td class="s5" colspan="2">Pre-Term/Partial Term</td><td class="s4" colspan="5"></td></tr>
        <tr><td class="s2">Water</td><td class="s10"></td><td class="s2">Exhaust</td><td class="s10"></td><td class="s5" colspan="2">Drainage TP</td><td class="s10"></td><td class="s3"></td><td class="s5" colspan="2">Tripartite Agreement</td><td class="s4" colspan="5"></td></tr>
        <tr><td class="s6"></td><td class="s6"></td><td class="s6"></td><td class="s6"></td><td class="s6"></td><td class="s6"></td><td class="s6"></td><td class="s3"></td><td class="s6"></td><td class="s6"></td><td class="s6"></td><td class="s6"></td><td class="s6"></td><td class="s6"></td><td class="s7"></td></tr>
        ...
        <tr><td class="s2">Contact No.</td><td class="s2"></td><td class="s4" colspan="5"></td><td class="s3"></td><td class="s5" colspan="2">Contact No.</td><td class="s4" colspan="5"></td></tr>
        <tr><td class="s2">E-mail Address</td><td class="s2"></td><td class="s4" colspan="5"></td><td class="s3"></td><td class="s5" colspan="2">E-mail Address</td><td class="s4" colspan="5"></td></tr>
        <tr><td class="s2">Type of Ownership</td><td class="s2"></td><td class="s4" colspan="5"></td><td class="s3"></td><td class="s5" colspan="2">Type of Ownership</td><td class="s4" colspan="5"></td></tr>
        <tr><td class="s2">Company Name</td><td class="s2"></td><td class="s4" colspan="5"></td><td class="s3"></td><td class="s5" colspan="2">Company Name</td><td class="s4" colspan="5"></td></tr>
        <tr><td class="s5" colspan="2">Developer Account Name</td><td class="s4" colspan="5"></td><td class="s3"></td><td class="s5" colspan="2">Developer Account Name</td><td class="s4" colspan="5"></td></tr>
        <tr><td class="s2">Business Address</td><td class="s2"></td><td class="s4" colspan="5"></td><td class="s3"></td><td class="s5" colspan="2">Business Address</td><td class="s4" colspan="5"></td></tr>
        <tr><td class="s5" colspan="2">Name of Authorized Representative</td><td class="s4" colspan="5">_CONTACT_PERSON_SOURCE_</td>
            <td class="s3"></td>
            <td class="s5" colspan="2">Name of Authorized Representative</td>
            <td class="s4" colspan="5"></td>
        </tr>
        <tr><td class="s5" colspan="2">Residence Address of Authorized Representative</td><td class="s4" colspan="5"></td><td class="s3"></td><td class="s5" colspan="2">Residence Address of Authorized Representative</td><td class="s4" colspan="5"></td></tr>
        <tr><td class="s2">Contact No.</td><td class="s2"></td><td class="s4" colspan="5">_CONTACT_NUMBER_</td><td class="s3"></td><td class="s5" colspan="2">Contact No.</td><td class="s4" colspan="5"></td></tr>
        <tr><td class="s2">E-mail Address</td><td class="s2"></td><td class="s4" colspan="5">_EMAIL_ADDRESS_</td><td class="s3"></td><td class="s5" colspan="2">E-mail Address</td><td class="s4" colspan="5"></td></tr>
        ...
        <tr><td class="s2">Name of Lessee</td><td class="s2"></td><td class="s4" colspan="5"></td><td class="s3"></td><td class="s5" colspan="2">Name of Sub-Lessee</td><td class="s4" colspan="5"></td></tr>
        <tr><td class="s2">Position</td><td class="s2"></td><td class="s4" colspan="5"></td><td class="s3"></td><td class="s5" colspan="2">Position</td><td class="s4" colspan="5"></td></tr>
        <tr><td class="s2">Contact No.</td><td class="s2"></td><td class="s4" colspan="5"></td><td class="s3"></td><td class="s5" colspan="2">Contact No.</td><td class="s4" colspan="5"></td></tr>
        <tr><td class="s2">E-mail Address</td><td class="s2"></td><td class="s4" colspan="5"></td><td class="s3"></td><td class="s5" colspan="2">E-mail Address</td><td class="s4" colspan="5"></td></tr>
        <tr><td class="s5" colspan="2">Name of Authorized Representative</td><td class="s4" colspan="5"></td><td class="s3"></td><td class="s5" colspan="2">Name of Authorized Representative</td><td class="s4" colspan="5"></td></tr>
        <tr><td class="s2">Business Address</td><td class="s2"></td><td class="s4" colspan="5"></td><td class="s3"></td><td class="s5" colspan="2">Business Address</td><td class="s4" colspan="5"></td></tr>
        ...
        <tr class="remarks-row">
            ...
            <td class="s5" colspan="7" style="white-space: normal; word-wrap: break-word; word-break: break-word; overflow-wrap: break-word; max-width: 100%; overflow: visible; text-overflow: clip; height: auto; line-height: 1.5; padding: 8px 6px;">_REMARKS_</td>
...
def display_site_photos(site_data):
    """Display photos for a site in a grid"""
        ...
        for col_idx in range(cols_per_row):
            ...
            if idx < len(photo_data):
                with row_cols[col_idx]:
                    ...
                    # Try to get actual image from Drive
                    image = get_image_from_drive(photo['filename'])
                    ...
                    if image:
                        ...
                        ">
                            ...
                            <div style="font-size: 10px; color: #999; margin-top: 5px;">
                                {photo['filename'][:30]}{'...' if len(photo['filename']) > 30 else ''}
                            </div>
                        </div>
                        """, unsafe_allow_html=True)
                    
                    st.caption(photo['column'])
    ...
    for col in DOC_COLUMNS:
        if col in site_data.index:
            ...
            if doc_value and str(doc_value).strip():
                ...
                # Check if it's an image (contains image file extension)
                doc_str = str(doc_value).strip().lower()
                is_image = any(ext in doc_str for ext in ['.jpg', '.jpeg', '.png', '.gif', '.webp'])
                
                if is_image:
                    # Try to display as image
                    filename = doc_str.split('/')[-1].split('\\')[-1]
                    image = get_image_from_drive(filename)
                    if image:
                        st.image(image, caption=col, use_container_width=True)
                    else:
                        st.markdown(f"""
                        <div style="
                            border: 1px solid #e0e0e0;
                        ...
                        ">
                            <div style="display: flex; align-items: center; gap: 10px;">
                                ...
                                <div>
                                    ...
                                    <div style="font-size: 12px; color: #666;">{doc_value}</div>
                                </div>
                            </div>
                        </div>
                        """, unsafe_allow_html=True)
    ...
    if not site_data.empty:
        ...
        with tab1:
            try:
                ...
                components.html(rendered_view, height=700, scrolling=True)
