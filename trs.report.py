...
/* 3. FIXED: REMOVE ALL CONTAINER PADDING & BORDERS - FULL BLEED LAYOUT */
.appview-container, 
.main, 
...
[data-testid="stMainBlockContainer"] {
    padding-top: 0px !important;      /* REMOVED TOP PADDING */
    padding-bottom: 0px !important;   /* REMOVED BOTTOM PADDING */
    padding-left: 0px !important;     /* REMOVED LEFT PADDING */
    padding-right: 0px !important;    /* REMOVED RIGHT PADDING */
    margin: 0px !important;
    border: none !important;          /* REMOVED BORDER */
    overflow: auto !important;
    height: auto !important;
    max-height: none !important;
    min-height: 150vh !important;     /* INCREASED HEIGHT AS REQUESTED */
    width: 100% !important;
...
/* 4. FIXED: REPORT VIEWER WITH PROPER SCROLLING - INCREASED HEIGHT */
iframe[title="streamlit_components.components.html"] {
    height: 800px !important;         /* INCREASED FROM 600px */
...
div[data-testid="stHorizontalBlock"] { 
    ...
    border-radius: 0px !important;    /* FLAT EDGES FOR FULL BLEED */
    margin-top: 0px !important; 
    margin-bottom: 0px !important;
    width: 100% !important;
}
