...
# UPDATE: Hardcoded to the exact user-provided Google Maps link
MAP_LAYER_URL = "https://www.google.com/maps/d/edit?mid=1CSUoDxCi-trQTTz_D6NjI3m0Kc5OQhM&usp=sharing" 
...
if st.session_state.show_modal and st.session_state.selected_site_display:
    ...
    if not site_data.empty:
        ...
        with m_head_col1:
            st.markdown(f"<div style='padding:8px 0 0 12px;'><b>SITE INFORMATION REPORT | PHOTOS | DOCS</b> ({target_sn})</div>", unsafe_allow_html=True)
        with m_head_col2:
