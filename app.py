...
# --- PERSISTENT DISK CACHE (Runs once, caches forever) ---
@st.cache_data(ttl=None, persist="disk", show_spinner="Loading document preview...")
def get_pdf_page_images(url: str):
...
if st.session_state.page_step == 'viewer':
    ...
    pages = get_pdf_page_images(DROPBOX_RAW_URL)
